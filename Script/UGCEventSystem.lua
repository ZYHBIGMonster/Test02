...
function UGCEventSystem:AddListener(EventType, Func, Object)
    ...
    if self.Events[EventType]==nil then
        ...
        print(string.format("UGCEventSystem:AddListener EventType[%s], Func[%s]", tostring(EventType), tostring(Func)));
    else
...
function UGCEventSystem:SendEvent(EventType, ...)
    print(string.format("UGCEventSystem:SendEvent self[%s], EventType[%s]", tostring(self), tostring(EventType)));
    if EventType ~= nil then
        ...
        if EventFuncs ~= nil then
            ...
            print(string.format("UGCEventSystem:SendEvent EventFuncs[%s] is nil!", tostring(EventType)));
        end
    end
end